...
const translations = {
  en: {
    ...
    search: "Search",
    sort: "Sort",
    openRouterModelSearchPlaceholder: "Search model names",
    openRouterNoResults: "No search results.",
    openRouterLoading: "Loading...",
    openRouterMaxShown: "Showing up to 100 models.",
    openRouterInputPrice: "Input",
    openRouterOutputPrice: "Output",
    openRouterContext: "Context",
    ...
    openRouterEnvMissingHint:
      "Server environment variable API key is missing. If selected, you'll be asked for a session key.",
    openRouterCostNotice:
      "OpenRouter uses external API calls and usage-based billing may apply.",
    openRouterSortCreatedDesc: "Newest first",
    openRouterSortContextDesc: "Longest context",
    openRouterSortPromptAsc: "Lowest input cost",
    openRouterSortCompletionAsc: "Lowest output cost",
    openRouterSortNameAsc: "Name",
    openRouterSelect: "Select",
    selected: "Selected",
    ollamaConnectHint:
      "Ollama requires a separate server. Connect with a local or remote Ollama instance URL.",
    ollamaUrl: "Ollama URL",
    connect: "Connect",
    ollamaSelectModel: "Select model",
    ollamaLoadModelsHint: "Click Connect to load the model list.",
    selectModelPlaceholder: "Select a model",
    ollamaNoServer: "No Ollama server was found at this URL.",
    ollamaConnected: "Ollama connected: {model}",
  },
  ko: {
    settings: "설정",
    close: "닫기",
    ...
    search: "검색",
    sort: "정렬",
    openRouterModelSearchPlaceholder: "모델 이름 검색",
    openRouterNoResults: "검색 결과가 없습니다.",
    openRouterLoading: "불러오는 중...",
    openRouterMaxShown: "최대 100개 모델을 표시했습니다.",
    openRouterInputPrice: "입력",
    openRouterOutputPrice: "출력",
    openRouterContext: "컨텍스트",
    ...
    openRouterEnvMissingHint:
      "서버 환경변수 API key가 없습니다. 모델 선택 시 세션용 API key를 입력받습니다.",
    openRouterCostNotice:
      "OpenRouter는 외부 API 호출 방식이며 사용량에 따라 비용이 발생할 수 있습니다.",
    openRouterSortCreatedDesc: "최신 등록순",
    openRouterSortContextDesc: "컨텍스트 긴 순",
    openRouterSortPromptAsc: "입력 비용 낮은 순",
    openRouterSortCompletionAsc: "출력 비용 낮은 순",
    openRouterSortNameAsc: "이름순",
    openRouterSelect: "선택",
    selected: "선택됨",
    ollamaConnectHint:
    ...
    ollamaUrl: "Ollama URL",
    connect: "연결",
    ollamaSelectModel: "모델 선택",
    ollamaLoadModelsHint: "연결을 눌러 모델 목록을 불러오세요.",
    selectModelPlaceholder: "모델을 선택하세요",
    ollamaNoServer: "해당 URL에 Ollama 서버가 없습니다.",
    ollamaConnected: "Ollama 연결 완료: {model}",
  },
} as const;
